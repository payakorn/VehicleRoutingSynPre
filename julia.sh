...
#SBATCH --time=100:00:00          ## เวลาที่ใช้รันงาน
...
# grbgetkey 33a2f816-9e2c-4023-9eff-db03959eb467
# mv ~/gurobi.lic ~/.julia/dev/VRPTW.jl/gurobi1.lic
# grbgetkey 33a2f816-9e2c-4023-9eff-db03959eb467 /home/payakorn.s/gurobi_cpu.lic

# export GRB_LICENSE_FILE=/home/payakorn.s/.julia/dev/VRPTW.jl/gurobi1.lic
# export GRB_LICENSE_FILE=/home/payakorn.s/gurobi_cpu.lic
...
srun julia --threads 32 src/script1.jl          ## สั่งรัน code
